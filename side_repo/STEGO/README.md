...
```
conda create -n stego python=3.6.9
conda install pytorch cudatoolkit=11.3 -c pytorch -c nvidia 
or  pip install torch==1.10.2+cu113 torchvision==0.11.3+cu113  --extra-index-url https://download.pytorch.org/whl/cu113
conda install torchvision -c pytorch -c nvidia
pip install matplotlib wget scipy torchmetrics tensorboard seaborn  hydra-core pytorch_lightning wandb loguru h5py einops
pip install git+https://github.com/lucasb-eyer/pydensecrf.git
pip install -e . at self-guidance
```
FOr convenience, you can also use sg conda environment.
