...
def parse_arguments():
    # python image2numpy_imagenet_val.py --in_dir /home/thu/data/imagenet_official_val_resized32/box --out_dir /home/thu/data/imagenet_official_np/size32/val
    
    # python image2numpy_imagenet_val.py --in_dir /home/thu/data/imagenet_official_val_resized64/box --out_dir /home/thu/data/imagenet_official_np/size64/val
    

    parser = ArgumentParser()
    parser.add_argument(
        '-i', '--in_dir', default='/home/thu/data/imagenet_val_resized32/lanczos', help="Input directory with source images")
    parser.add_argument(
        '-o', '--out_dir', default='/home/thu/data/imagenet_val_resized32_np',
...
def process_folder(in_dir, out_dir):
    ...
    images = []
    image_names = []
    for _, image_name in enumerate(os.listdir(in_dir)):
