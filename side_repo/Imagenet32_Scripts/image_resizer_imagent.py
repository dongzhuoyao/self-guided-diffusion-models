...
#download and prepare imagenet following: https://gist.github.com/bonlime/4e0d236cf98cd5b15d977dfa03a63643

def parse_arguments():
    # python image_resizer_imagent.py -i /home/thu/data/imagenet_official/train -o /home/thu/data/imagenet_official_train_resized32 -r -a box  -j 40
    # python image_resizer_imagent.py -i /home/thu/data/imagenet_official/val -o /home/thu/data/imagenet_official_val_resized32 -a box  -j 10
    
    # python image_resizer_imagent.py -i /home/thu/data/imagenet_official/train -o /home/thu/data/imagenet_official_train_resized64 --size 64 -r -a box  -j 40 
    # python image_resizer_imagent.py -i /home/thu/data/imagenet_official/val -o /home/thu/data/imagenet_official_val_resized64 --size 64 -a box  -j 10
    
    
    parser = ArgumentParser()
    parser.add_argument(
        '-i', '--in_dir', help="Input directory with source images", default='/home/thu/data/imagenet/train', required=True)
    parser.add_argument(
        '-o', '--out_dir', help="Output directory for resized images",  default='/home/thu/data/imagenet_train_resized32', required=True)
...
def resize_img_folder(in_dir, out_dir, alg):
    ...
    if alg_val is None:
        print(
            "Sorry but this algorithm (%s) is not available, use help for more info." % alg)
        return
    ...
    for filename in os.listdir(in_dir):
        ...
        try:
            ...
            print(f"This file {filename} couldn't be read as an image")
    ...
    for alg in algs:
        ...
        if recurrent:
            ...
            folders = [dir for dir in sorted(os.listdir(
                in_dir)) if os.path.isdir(os.path.join(in_dir, dir))]
